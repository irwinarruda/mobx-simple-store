...
type ToModel<T> = {
  [P in NotNullableKeys<T>]: T[P] extends MSSModel<infer O, infer OV, infer OA> // Model
  ...
  [P in NullableKeys<T>]?: T[P] extends MSSMaybeNull<infer C> // MaybeNull
    ? C extends MSSModel<infer O, infer V, infer A> // MaybeNull of Model
      ...
      ? D extends MSSModel<infer O, infer OV, infer OA> // MaybeNull of Array of Model
        ...
        ? E extends MSSModel<infer F, infer FV, infer FA> // MaybeNull of Array of MaybeNull of Model
          ? Nullable<
              Nullable<
                ObservableArray<ToModel<F & FV & ParseActions<FA>>, ToModel<F>>
              >
            >
